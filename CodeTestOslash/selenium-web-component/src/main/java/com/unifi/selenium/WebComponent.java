...
public abstract class WebComponent
    ...
    public WebComponent(WebDriver driver, WebElement parent) {
        this.driver = driver;
        this.wrappedWebElement = parent;
        this.delegateWebElement = parent;
    }
    ...
    public void init(WebElement wrappedWebElement, WebElement delegateWebElement, WebDriver driver) {
        this.wrappedWebElement = wrappedWebElement;
